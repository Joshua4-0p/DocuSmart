            ...
            switch (key) {
              ...
              case 'volunteer':
                return profile.volunteer.length > 0 ? (
                  <div key="volunteer">
                    <div style={sectionHead}>{labels.volunteer}<span style={{ flex: 1, height: '1px', background: hexWithAlpha(accent, 0.18) }} /></div>
              ...
              case 'publications':
                return profile.publications.length > 0 ? (
                  <div key="publications">
                    <div style={sectionHead}>{labels.publications}<span style={{ flex: 1, height: '1px', background: hexWithAlpha(accent, 0.18) }} /></div>
