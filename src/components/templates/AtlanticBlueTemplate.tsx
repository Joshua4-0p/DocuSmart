                  ...
                  <div key="volunteer">
                    ...
                    {profile.volunteer.map((vol) => (
                      <div key={vol.id} style={{ marginBottom: `${Math.round(10 * sp)}px` }}>
                        ...
                        {vol.description && <p style={{ fontSize: '9pt', color: '#444', margin: 0, lineHeight: '1.4' }}>{vol.description}</p>}
                      </div>
                    ))}
                  </div>
                ) : null
                  ...
                  <div key="publications">
                    ...
                    {profile.publications.map((pub) => (
                      <div key={pub.id} style={{ marginBottom: `${Math.round(8 * sp)}px` }}>
                        ...
                        {pub.description && <p style={{ fontSize: '9pt', color: '#444', margin: 0, lineHeight: '1.4' }}>{pub.description}</p>}
                      </div>
                    ))}
                  </div>
                ) : null
